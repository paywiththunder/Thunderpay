...
export default function SetupThunderPin() {
  ...
  const handleBack = () => {
    ...
    // step 1 has no back (WelcomeStep handles its own CTA)
  };
  ...
  const handleConfirmChange = (index: number, value: string) => {
    ...
    if (newCodes.every((code) => code !== "") && index === 3 && step === 3) {
  ...
  return (
    <div className="h-screen bg-black text-white flex flex-col px-6 justify-center items-center py-10 w-full">
      ...
      {(step === 2 || step === 3) && (
        <div className="flex flex-col w-full flex-1 min-h-full py-6">
          ...
          <div className="flex flex-col items-center justify-center flex-1 px-4 pb-6">
            <div className="flex flex-col items-center gap-8 w-full max-w-sm">
              <p className="text-gray-400 text-center mb-4">
                {step === 2 ? "Enter your new 4-digit PIN." : "Re-enter your PIN to confirm."}
              </p>
