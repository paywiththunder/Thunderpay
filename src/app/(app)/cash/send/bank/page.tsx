    ...
    if (transactionResult === "success") {
      return (
        <PaymentSuccess
          ...
          token={transferData?.reference || transactionToken}
          biller={selectedBank.name}
          billerLabel="Bank Name"
          meterNumber={transferData?.recipientAccountNumber || accountNumber}
          meterNumberLabel="Account Number"
          customerName={transferData?.recipientAccountName || accountName}
          customerNameLabel="Account Name"
          meterType="Bank Transfer"
          meterTypeLabel="Transfer Type"
          serviceAddress=""
