...
export default function DataPage() {
    ...
    const { isFetching: isPlansLoading, data: queryPlans } = useQuery({
        ...
        <div className="flex flex-col w-full flex-1 bg-black min-h-full py-6">
            ...
            <div className="flex flex-col gap-6 px-4 overflow-y-auto pb-6">
                    ...
                    <div className="relative" ref={networkDropdownRef}>
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-linear-to-b from-yellow-500 to-orange-500 flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-0 bg-linear-to-b from-[#161616] to-[#0F0F0F] border border-white/20 rounded-2xl overflow-hidden">
                        <button
                            ...
                            className={`flex-1 py-3 px-4 text-sm font-medium transition-colors ${offerCategory === "hot-offers" ? "bg-gray-700 text-white" : "text-white/70 hover:text-white"}`}
                        >
                            Hot Offers
                        </button>
                        ...
                        <button
                            ...
                            className={`flex-1 py-3 px-4 text-sm font-medium transition-colors ${offerCategory === "daily" ? "bg-gray-700 text-white" : "text-white/70 hover:text-white"}`}
                        >
                            Daily
                        </button>
                        <div className="w-px bg-white/20"></div>
                        <button
                            ...
                            className={`flex-1 py-3 px-4 text-sm font-medium transition-colors ${offerCategory === "weekly" ? "bg-gray-700 text-white" : "text-white/70 hover:text-white"}`}
                        >
                            Weekly
                        </button>
                    </div>
                        ...
                        {isPlansLoading ? (
                            ...
                            filteredPlans.map((plan, i) => (
                                <button
                                    ...
                                    className={`bg-linear-to-b from-[#161616] to-[#0F0F0F] border border-white/20 rounded-2xl p-4 flex flex-col items-center justify-center hover:bg-gray-800/50 transition-colors ${selectedPlan?.id === plan.id ? "ring-2 ring-blue-500 border-blue-500" : ""}`}
                                >
                ...
                <button
                    ...
                    className={`w-full py-4 rounded-full font-bold text-white transition-all mt-4 mb-20 bg-linear-to-b from-[#161616] to-[#0F0F0F] border border-white/20 shadow-[inset_0_1px_4px_rgba(255,255,255,0.1)] hover:bg-gray-800/50 ${!phoneNumber || !selectedPlan || !phoneVerified ? "bg-gray-900 text-gray-600 border border-gray-800 cursor-not-allowed" : ""}`}
                >
                    Pay
                </button>
            </div>
