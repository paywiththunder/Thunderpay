...
const electricityProviders: ElectricityProvider[] = [
  { id: "ikeja", name: "Ikeja Electricity", logo: "IE" },
  { id: "enugu", name: "Enugu Electricity", logo: "EE" },
  { id: "ibadan", name: "Ibadan Electricity", logo: "IB" },
  { id: "jos", name: "Jos Electricity", logo: "JE" },
  { id: "kaduna", name: "Kaduna Electricity", logo: "KE" },
  { id: "ph", name: "Port Harcourt Electricity", logo: "PH" },
  { id: "abuja", name: "Abuja Electricity", logo: "AE" },
  { id: "kano", name: "Kano Electricity", logo: "KN" },
];
